...
export interface TaskSettings {
  ...
  i_order_auto_close_hours: number;
...
export const updateTaskSettings = (i_review_timeout_hours: number, i_order_auto_close_hours: number) =>
  api.patch<ApiResponse<TaskSettings>>(`/task-settings`, { i_review_timeout_hours, i_order_auto_close_hours });
